...
export default function TodoListComponent() {
  ...
  return <>
    <div className="border p-5 self-center rounded-xl w-1/3 min-h-64 py-7 space-y-5 > * + *">
  ...
  return (
    <form onSubmit={handleAddItem}>
      <div className="flex justify-between">
        <input name="todoInput" className="m-1 px-2 border border-grey-300 w-full rounded" type="text" />
...
function ItemList({ todoList, setTodoList }: { todoList: itemCheckList[], setTodoList: any}) {
  return (
